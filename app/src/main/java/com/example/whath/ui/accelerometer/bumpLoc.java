...
import com.example.whath.ui.videoplayer.videoLocalRight;
 ...
 */
public class bumpLoc extends AppCompatActivity implements SensorEventListener{
...
//        startActivity(intent3);
        ...
        {
            Intent intent = new Intent(bumpLoc.this,videoLocalRight.class);
            startActivity(intent);
        }
        else if(x>0 && Math.sqrt(x * x + y * y + z * z)>=12)
        {
            Intent intent2 = new Intent(bumpLoc.this,videoLocal.class);
